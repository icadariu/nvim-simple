...
vkms("n", "<leader><Tab>tc", utils.toggle_cursor_column, { desc = "Toggle Cursor Column" })
vkms("n", "<leader><Tab>tm", utils.toggle_mouse, { desc = "Toggle Mouse" })
vkms("n", "<leader><Tab>ts", utils.toggle_spell_check, { desc = "Toggle spell" })
vkms("n", "<leader>uf", utils.toggle_autoformat, { desc = "Toggle Autoformat on save" })
